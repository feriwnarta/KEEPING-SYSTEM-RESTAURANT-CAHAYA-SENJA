    ...
    <div class="row">
        <div class="col-sm-7">
            <form class="form-update-keeping" id="<?= $data['data_update']['id'] ?>">
                ...
                <div class="form-floating mb-4 ">
                    <input type="number" class="form-control input-count-product" id="floatingInput" placeholder="name@example.com" name="inputCustName" value="<?= $data['data_update']['product_count'] ?>" disabled>
                    <label for="floatingInput">Jumlah</label>
                </div>

                <div class="form-floating mb-4">
                    <select class="form-select" id="productDropdown" aria-label="Floating label select example" class="select-product" disabled>
